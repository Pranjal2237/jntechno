...
import { digital, graphics61, terms, workplaceBanner } from "@/public"
...
const page = () => {
  return (
    <div>
      <Banner image={workplaceBanner} heading="Connected Enterprises – Radically Reforming Companies and Competition" height="560px" />
      <div
        style={{
          padding: "1rem 0",
      ...
      <div style={{ marginBlock: "2rem" }}>
        ...
        >
          ...
          >
            <Image src={graphics61} style={{ width: "80%" }} />
          </div>
        </div>
      </div>
