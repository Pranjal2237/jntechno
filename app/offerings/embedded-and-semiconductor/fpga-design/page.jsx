...
import { digital, fpgaBanner, graphics31, terms } from "@/public"
...
const page = () => {
  return (
    <div>
      <Banner image={fpgaBanner} heading="Connected Enterprises – Radically Reforming Companies and Competition" height="560px" />
      <div
        style={{
          padding: "1rem 0",
      ...
      <div style={{ marginBlock: "2rem" }}>
        ...
        >
          ...
          >
            <Image src={graphics31} style={{ width: "80%" }} />
          </div>
        </div>
      </div>
      <div
