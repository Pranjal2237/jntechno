...
import { cyberBanner, digital, terms } from "@/public"
...
const page = () => {
  return (
    <div>
      <Banner image={cyberBanner} heading="Connected Enterprises – Radically Reforming Companies and Competition" height="560px" />
      <div
        style={{
          padding: "1rem 0",
