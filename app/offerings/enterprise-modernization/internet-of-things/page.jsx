...
import { digital, iotBanner, terms } from "@/public"
...
const page = () => {
  return (
    <div>
      <Banner image={iotBanner} heading="Connected Enterprises – Radically Reforming Companies and Competition" height="560px" />
      <div
        style={{
          padding: "1rem 0",
