...
import { digital, platformBanner, terms } from "@/public"
...
const page = () => {
  return (
    <div>
      <Banner image={platformBanner} heading="Connected Enterprises – Radically Reforming Companies and Competition" height="560px" />
      <div
        style={{
          padding: "1rem 0",
