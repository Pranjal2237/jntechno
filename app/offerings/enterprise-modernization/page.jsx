...
import { digital, enterpriseModernizationBanner, graphics23, graphics27 } from "@/public"
...
const page = () => {
  return (
    <div>
      <Banner image={enterpriseModernizationBanner} heading="Driving Enterprise Evolution: Modernize for Success" height="560px" />
      <div
        style={{
          padding: "1rem 0",
      ...
      <div style={{ marginBlock: "3rem" }}>
        <div className="wrapper">
          ...
          <div className="offering-container">
            {enterpriseModOfferings.map(({ image, title, paragraph,haveLink,link }) => (
              <div>
