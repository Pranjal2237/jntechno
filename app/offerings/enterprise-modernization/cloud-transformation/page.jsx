...
import { cloudTransformationBanner, digital} from "@/public"
...
const page = () => {
  return (
    <div>
      <Banner image={cloudTransformationBanner} heading="Fast Forward Your Business With Cloud Transformation Solutions" height="560px" />
      <div
        style={{
          padding: "1rem 0",
