      ...
      <div>
        <div style={{ width: "1100px", marginInline: "auto" }}>
          ...
          <p style={{ color: "#333", fontSize: "17px" }}>
            ...
            products or services obtained from this Website. Any reproduction,
            publication, further distribution or public exhibition of materials
            provided through the Website, in whole or in part, is strictly
            prohibited.
          </p>
          <h2
            style={{ marginTop: "4rem", fontSize: "26px", fontWeight: "600" }}
          ...
          <p style={{ color: "#333", fontSize: "17px" }}>
            ...
            believed to be reliable, but that no guarantees are made by ACL
            Digital or the providers of the Third Party Content as to its
            accuracy, completeness or timeliness. You agree not to hold ACL
            Digital’s any business offering products or services through the
          ...
          <p style={{ color: "#333", fontSize: "17px" }}>
            ...
            associated with the foregoing is the exclusive property of ACL
            Digital.
          </p>
          <h2
            style={{ marginTop: "4rem", fontSize: "26px", fontWeight: "600" }}
