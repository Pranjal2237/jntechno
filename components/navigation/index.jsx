...
import { adminNav, navigation } from "@/constant";
import Link from "next/link";
import { usePathname } from "next/navigation";
import { userVerify } from "@/services/userServices";
    ...
    <div className={isscroll === true ? "header scroll" : "header"}>
      <nav className="nav wrapper">
        <div className="nav_data">
          ...
          <div
            className={isOpen ? "nav_toggle active" : "nav_toggle"}
            onClick={() => {
              setIsOpen(!isOpen);
            }}
          >
              ...
              <li>
                <div className="dropdown_button">
                  ...
                  >
                    <h5
                      style={
                        "admin" === activePath ? { fontWeight: "600" } : {}
                      }
                    >
                      Admin
                    </h5>
                  ...
                  <div className="dropdown_container wrapper">
                    <div className="dropdown_content">
                      {adminNav.map(({ heading, options }) => (
                        <div className="dropdown_group">
                          <div className="dropdown_title">{heading}</div>
                          <ul className="dropdown_list">
                            {options.map(({ option, optionLink }) => (
                              <li>
                                <Link
